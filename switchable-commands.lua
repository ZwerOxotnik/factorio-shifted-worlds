...
return {
	teleport = {name = "teleport", description = {"example-mod-commands.teleport"}, only_for_admin = true},
	update_teleport_timer = {name = "update-teleport-timer", description = {"example-mod-commands.update-teleport-timer"}, only_for_admin = true}
}
